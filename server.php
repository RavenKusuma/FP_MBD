<?php 
	...
	if (isset($_POST['reg_user'])) {
		...
		if (count($errors) == 0) {
			...
			$query = "INSERT INTO pelanggan (username_pelanggan, password_pelanggan, nama_pelanggan, alamat_pelanggan, tlp_pelanggan, tgl_lahir) 
					  VALUES('$username', '$password', '$nama', '$alamat', '$no_tlp', '$tgl_lahir')";
